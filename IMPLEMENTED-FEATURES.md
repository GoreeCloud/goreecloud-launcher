...
The current repository `main` head and latest source-bearing Launcher runtime are `c09e2d581f300271f762422eef206631769f73b1`, the guarded squash merge of PR #223, **Use gesture-only app drawer dismissal**. PR #223 exact head `2fe8ed2046daca56202ef07873a806a9b09a7c30` passed Android CI run #693 / `35813157287` across the repository validation/build/unit/schema/APK staging, Android 16 Room/runtime emulator, and Android 16 transition-performance emulator lanes before merge. This baseline also includes PR #221's 5 × 6 starter Home/five-app Dock defaults at `384568dda7abcf0a7e2c0942773efa540b70af2c`, PR #219's AppWidgetHost-based Home widgets at `42513fb80ec2caea8431437664a96abb1a605f1f`, PR #215's unified Home/Dock/App Drawer drag-and-edit interactions at `12634e7388f6c997debb255874136f80cc720830`, and PR #212's source-manifest reconciliation at `53e79befaf7f76b1abf27acecf8a3c838515f34b`.
...
- App drawer header is informational only: the former Settings and explicit Close action buttons are removed.
- Downward swipe is the drawer's in-surface dismissal interaction; Android HOME remains the platform/system return path.
- Launcher Settings remains reachable from the Home long-press editor sheet through its existing **Settings** action rather than from an app-drawer header control.
