...
/**
 * Device-local list of Storage Access Framework roots explicitly selected for Launcher file search.
 *
 * The Launcher persists only the URI grants selected by the user. File names, query history, file
 * contents, and result history are not written to this store.
 */
