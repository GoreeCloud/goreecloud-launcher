        ...
        setContent {
            ...
            if (!LauncherPortableRestoreStartupGate.allowsMutations(portableRestoreRecovery)) {
                GlazeTheme(themeMode) {
                    LauncherRecoveryGateSurface(
                        message = LauncherPortableRestoreStartupGate.userMessage(
                            portableRestoreRecovery,
                        ),
                    )
                }
                return@setContent
...
@Composable
private fun LauncherRecoveryGateSurface(message: String) {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .statusBarsPadding()
        ...
        Surface(
            ...
            Column(Modifier.padding(24.dp)) {
                ...
                Text(
                    text = "Home editing and restore changes remain paused to protect your workspace.",
