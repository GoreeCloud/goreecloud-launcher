...
- Source changes require fresh exact-head Platform Contract and Android CI, including the repository's runtime emulator lane, before integration may be considered.
