...
- PR #139 exact head `015760550f678275f9df74fd4179e0664c9842ac` passed Android CI `35528584725`, merged as `b5556b8868f8c4e8719f1d3ab888a143d1a79771`, and exact-main Android CI `35528892745` passed. PR #142 exact head `e2f51a597dc2c083b9ac2583f709f93ba3786c91` passed Android CI `35529806000`, merged as `3ba29395b7b81b69194339b0ae32e2babea28afd`, and exact-main Android CI `35530147383` passed. All cited runs include validate and Android 16 room-runtime-emulator.
- Exact-main artifact `10611296383` is bound to current runtime main `3ba29395b7b81b69194339b0ae32e2babea28afd`; archive digest is `sha256:c3ad5330684acab625bbbee43b39cdbfbe30e277936bb2ee7f98ac6418970b4c` and extracted `GoreeCloud-Launcher-Dev.apk` SHA-256 is `349d63bde32d39c8d4542989d5dc3b928590fabfab994951ee4353602f43c4ad`.
...
| --- | --- | --- | --- |
| LCH-P0-01 | HOME return and workspace gesture stabilization: preserve primary-Home return, reliable content-origin drawer gesture handling, and smooth state transitions without whole-root recreation. | P0 / High | PR #139 and PR #142 are integrated on current main. Home is now wallpaper-first with a one-time starter layout, long-press Home editor, configurable glance alignment, dock/search/material controls, and page dots while preserving existing HOME/drawer gesture contracts. Representative physical-device/default-HOME visual, gesture, and transition acceptance remains pending under issue #80. |
...
| LCH-P1-03 | GLAZE UI V1.6 personalization and presentation: current theme authority, icon packs/masking/normalization, wallpaper palettes, drawer/folder/dock styling, density, motion, reduced-motion/transparency, contrast, scalable text, optical behavior, and touch accessibility. | P1 / High | Official Stable GLAZE UI V1.6 / `1.6.0` source mapping is integrated through PR #128. PR #139 and PR #142 extend the rendered Glaze experience with wallpaper-first Home treatment, Home editor, dock/wallpaper/search controls, paged drawer presentation, configurable page density, and Home glance alignment. Application-specific accessibility/adaptive/device/performance/rollback/Human Visual Excellence acceptance remains blocked; this is still Development, not full consumer acceptance. |
...
- Representative-device review of the PR #142 inspiration-driven Home/drawer/settings experience, followed by measured frame timing/jank correction and transition tuning.
- Category, Search-first, broader density/spacing/label controls, and expanded one-handed reachability for the app drawer.
- Broader Launcher settings/personalization coverage beyond PR #142 for dock pages, folders, widgets, configurable gestures, wallpaper palettes, deeper translucency/motion controls, icon treatment, backup/recovery, and accessibility as the corresponding runtime capabilities become real.
