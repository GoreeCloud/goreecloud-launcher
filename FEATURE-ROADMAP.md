...
| LCH-P1-01 | Workspace editing: complete primary-grid migration, mature cross-page drag/drop, folders, smart folders, categories/tags/favorites/collections, page management, and safe destructive-edit recovery. | P1 / High | A stacked Development tranche in Draft PR #98 adds explicit Home overview/edit mode with ordered page previews, page selection, accessible non-drag Earlier/Later reordering, page creation, confirmed safe deletion of completely empty non-primary pages, layout-lock enforcement, and fail-closed primary-rank protection. Room remains authoritative and previews do not claim exact Room cell positions. Exact-head CI for the final PR #98 head plus representative physical-device/accessibility acceptance remain required. Multi-select, mature drag/drop, folders, undo/history, and broader organization remain planned. |
...
- Draft PR #98 on `feat/home-overview-edit-mode-20260913` adds an explicit Home overview/edit surface with ordered page cards, bounded count previews, selection, non-drag Earlier/Later reordering, page creation, and confirmed deletion for completely empty non-primary pages only.
...
- Multi-select edit mode, group movement, direct drag workflows, page cleanup assistance, and safe undo/history on top of the explicit Home overview foundation.
