...
The governing V1.2 material rule is: **Neutral glass is the material; color is an accent.** Decorative color cannot establish protection, privacy, identity, recovery, availability, focus, selection, or other authoritative state.
